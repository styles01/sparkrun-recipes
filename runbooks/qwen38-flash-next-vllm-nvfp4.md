...
> llama.cpp Q3_K_XL 2-lane primary recipe:
> - **vLLM + NVFP4 wins** on chat, reasoning, and anything that reads long
>   documents — flat decode at depth, ~5× faster prefill, native MTP head.
> - **llama.cpp Q3 2-lane wins** on concurrent coding-agent load (~43-50 tok/s
>   aggregate across 2 lanes).
>
...
- **Two sequences, not two hundred.** If a chat UI, a coding agent and a
  background job all point at this endpoint, they share two slots and queue.
